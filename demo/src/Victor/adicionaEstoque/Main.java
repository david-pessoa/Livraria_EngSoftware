...
public class Main {
  public static void main(String[] args) {
    ...
    LinkedList<Produtos> produtos = new LinkedList<>();
    produtos.add(new Produtos(new Livro(4, "Livro 4", 40.0f, "Autor 4", "Categoria 1"), 15));
    produtos.add(new Produtos(new Livro(5, "Livro 5", 50.0f, "Autor 5", "Categoria 2"), 12));
    produtos.add(new Produtos(new Livro(6, "Livro 6", 60.0f, "Autor 1", "Categoria 3"), 8));
    produtos.add(new Produtos(new Livro(7, "Livro 7", 100.0f, "Autor 2", "Categoria 3"), 20));
    produtos.add(new Produtos(new Livro(8, "Livro 8", 10.0f, "Autor 5", "Categoria 4"), 9));

    controller.adicionaFornecedora("Fornecedora 3", "456789123", "ghi@mail.com", "senha", produtos, "987.654.123-00");
    ...
    if (input == 3) {
      if (flag_login) {
        ...
        if (input2 == 1) {
          ...
          if (controller.addNoEstoque(id, nome_livro, preco, autor, categoria, quant, data_envio, data_recebimento)) { //função
            System.out
          ...
          System.out.print("data de recebimento: ");
          String data_recebimento = scanner.nextLine();
          if (controller.addNoEstoque(nome_livro, quant, data_envio, data_recebimento)) { //função
            System.out.println("\nmudança de estoque realizada com sucesso!\ncomprovante de compra foi enviada pelo email\n\n");
          } else {
            System.out.println("\nnão foi possivel adicionar o produto\n\n");
          }
